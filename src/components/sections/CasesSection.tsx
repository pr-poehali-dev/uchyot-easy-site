          ...
          {[
            {
              ...
              task: 'Автоматизация учета рейсов и расчета зарплаты водителей',
              solution: 'Интеграция с 1С и GPS-трекингом, автоматический расчет выплат',
              result: 'Экономия 40 часов в месяц на учете и начислениях',
              icon: 'Truck'
            },
            {
              company: 'Сеть кофеен',
            ...
            },
            {
              ...
              solution: '20+ источников данных, автоматизация отчетов для клиентов',
