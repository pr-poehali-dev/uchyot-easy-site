          ...
          {[
            {
              ...
              solution: 'Учёт заказов, контроль закупок и расчетов с поставщиками с учетом конвертации валют',
              result: 'Контроль остатков на 7 складах, отчетность по продажам, ABC-анализ ассортимента',
              icon: 'ShoppingCart'
            },
            {
              company: 'Сеть кофеен',
